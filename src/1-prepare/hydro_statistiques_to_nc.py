...
folder_save = r'p:\11208719-interreg\data\hydroportail\b_final'

daily = 'QJ-X_(CRUCAL)'
hourly = 'Q-X_(CRUCAL)'

timestep = hourly  # or hourly
...
file1 = os.path.join(folder_p, 'la_meuse_a_chooz', daily, 'QJ-X-(CRUCAL)_Gumbel_B7200000_01-01-1953_06-02-2023_1_non-glissant_X_pre-valide-et-valide_ResultatsAjustement.csv')
