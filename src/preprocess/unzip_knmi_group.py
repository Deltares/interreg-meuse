...
# #Inital file locaiton
# file = os.path.join(f"full_ds/{member_number}/{var_name}/{var_name}.KNMI-{year_name}.KEXT12.kR2v3-v578-fECEARTH3-ds23-{member_name}+hist.DD.nc")
# print("Initial file is: ", file)
...
for year in np.arange(year_start, year_end+1):
    ...
    file = os.path.join(f"full_ds/{member_number}/{var_name}/{var_name}.KNMI-{year}.KEXT12.kR2v3-v578-fECEARTH3-ds23-{member_name}+hist.DD.nc")
    ...
    new_name = os.path.join(f"full_ds/{member_number}/{var_name}/{var_name}.KNMI-{year}.{member_number}.nc")
